 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_attcontrol_duration_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'general', get_string('changeduration', 'attcontrol'));
        $mform->addElement('static', 'count', get_string('countofselected', 'attcontrol'), count(explode('_', $ids)));
        ...
        $mform->addGroup($durselect, 'durtime', get_string('newduration', 'attcontrol'), array(' '), true);
